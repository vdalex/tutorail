...
int main()
{
	...
	dbus_uint32_t flag; /* Currently this is not used by DBus, they say it is for future expansion*/
	dbus_bool_t result;
	...
	message = dbus_message_new_method_call("org.freedesktop.DBus", "/org/freedesktop/DBus", "org.freedesktop.DBus","StartServiceByName");
